...
def setup():
    ...
    GPIO.setup(buttonPin, GPIO.IN,
               pull_up_down=GPIO.PUD_UP)  # Set buttonPin to INPUT mode, and pull up to HIGH level, 3.3V
...
def alertor():
    p.start(50)
    for x in range(0, 90):  # Make frequency of the alertor consistent with the sine wave
        sinVal = math.sin(x * (math.pi / 180.0))  # calculate the sine value
        toneVal = 500 - sinVal * 400  # Add to the resonant frequency with a Weighted
